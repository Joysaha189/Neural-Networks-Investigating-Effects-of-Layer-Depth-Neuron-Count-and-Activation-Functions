...
- **Configurable Architecture:**  
  2–4 layers with customizable hidden neurons.

- **Activation Functions:**  
  ReLU, Sigmoid, and Leaky ReLU.

- **Custom Optimizers:**  
  Batch Gradient Descent and Adam Optimizer (implemented from scratch).

- **Multi-class Classification:**  
  Softmax output layer with Categorical Cross-Entropy loss.
...
| Iris     | 150       | 4        | 3       | Classic Low-dimensional  |
...
- **Optimizers:**  
  Adam consistently outperformed Batch Gradient Descent, especially on MNIST and F-MNIST.

- **Activation Functions:**  
  Leaky ReLU prevented dead neurons and achieved the highest accuracy. Sigmoid struggled in deeper networks.

- **Network Depth:**  
  3–4 layers improved performance on complex datasets, while simpler tasks like Iris performed well with 2 layers.

- **Dimensionality Effects:**  
  High-instance datasets performed well, whereas high-dimensional low-sample datasets (e.g., Leukemia) remained challenging.
...
1. **MNIST / F-MNIST**  
   [ICSI_536_Projects_MNIST_FMNIST.ipynb](https://colab.research.google.com/drive/196LaYGn15E3WngLrmtQKPjzAPrmXJK62?usp=sharing)  
   - Requires Kaggle API key for dataset download.

2. **Iris & Other Datasets**  
   [ICSI_536_Projects_IRIS_and_others.ipynb](https://colab.research.google.com/drive/1odcjhmLmNHk9xO8Y258fOhDv3Kkhay2I?usp=sharing)

3. **Plotting Results**  
   [ICSI_536_Projects_Plot_All_results.ipynb](https://colab.research.google.com/drive/1oXDWfBN8m4q3pAtry3YzXkxSOVBwsuex?usp=sharing)
...
2. Upload it to your own Colab environment (optional but recommended).  
3. Run **Runtime → Run all**.  
4. For MNIST/F-MNIST, replace the Kaggle API key in the second cell if required.
